...
class MyModel:
    ...
    def giveAModelNum1(self):
        ...
        oneMoreLayer = Dense(features*6,kernel_initializer='normal', activation='relu',kernel_regularizer=regularizers.l2(0.1))(oneMoreLayer)
...
#        plot_model(model, self.name+'Arch.png', True)
    ...
    def giveAModelNum(self):
        ...
        oneMoreLayer = Dense(features*6,kernel_initializer='normal', activation='relu',kernel_regularizer=regularizers.l2(0.1))(oneMoreLayer)
        #oneMoreLayer = Dropout(0.5)(oneMoreLayer)
        #oneMoreLayer = Dense(features*2,kernel_initializer='normal', activation='relu')(oneMoreLayer)
...
np.random.seed(42)
X = genfromtxt('trainingData.csv', delimiter=',')
Y = genfromtxt('trainingData.csv', delimiter=',')
X1=np.delete(X,0,0)
